...
from oceens.models import User
...
# La racine du projet est trois dossiers au-dessus : src/oceens/core/database.py.
# Elle n'a de sens que depuis un clone : une fois le paquet installé hors du
# dépôt (image Docker), LOCAL_DATABASE_DIR doit être défini.
